...
class RoomTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'extra_mattress_price' => 'nullable|numeric|min:0',
            'day_use_enabled' => 'nullable|boolean',
            'day_use_price_4h' => 'nullable|numeric|min:0',
            'day_use_price_8h' => 'nullable|numeric|min:0',
        ]);
        ...
        $roomType = RoomType::create([
            ...
            'child_price' => $request->input('child_price', 0),
            'extra_mattress_price' => $request->input('extra_mattress_price', 0),
            'day_use_enabled' => $request->boolean('day_use_enabled'),
            'day_use_price_4h' => $request->input('day_use_price_4h'),
            'day_use_price_8h' => $request->input('day_use_price_8h'),
        ]);
