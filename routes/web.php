...
use App\Services\Checkout\CoreCheckoutHandler;

Route::get('/checkout', [CoreCheckoutHandler::class , 'show'])->name('checkout.show');
Route::get('/checkout/add-room', [CoreCheckoutHandler::class , 'addRoom'])->name('checkout.add-room');
Route::post('/checkout', [CoreCheckoutHandler::class , 'store'])->name('checkout.store');
Route::get('/api/availability', [\App\Http\Controllers\Admin\BookingAvailabilityController::class , 'check'])->name('api.availability');
