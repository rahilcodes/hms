...
@section('content')
    <div class="min-h-screen bg-slate-50 flex items-center justify-center p-6" x-data="{ step: 1, identity: '', loading: false }">
        <div class="w-full max-w-md">
            ...
            <div
                ...
                <form action="{{ route('guest.verify') }}" method="POST" class="p-10 pt-0 space-y-6" @submit="loading = true">
                    @csrf
            ...
            <div class="mt-8 text-center space-x-6 flex items-center justify-center">
                ...
                <a href="{{ route('admin.login') }}"
                    class="text-[10px] font-black text-slate-500 uppercase tracking-widest hover:text-blue-600 transition">
                    Staff/Owner Login
                </a>
            </div>
        </div>
