            ...
            <div class="bg-white w-full max-w-md rounded-3xl shadow-2xl overflow-hidden" @click.away="showModal = false">
                ...
                <form
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label
                                class="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 ml-1">Price Unit</label>
                        ...
                        <div class="col-span-2">
                             <div class="grid grid-cols-2 gap-4">
                                 <div>
                                     <label class="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1.5 ml-1">Safety Constraint</label>
                                     <select name="max_quantity_rule" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-sm font-bold focus:ring-2 focus:ring-blue-500 focus:bg-white transition outline-none">
                                         <option value="none" :selected="!editingService || !editingService.constraints || !editingService.constraints.max_quantity_rule">None (Unlimited)</option>
                                         <option value="room_extra_capacity" :selected="editingService && editingService.constraints && editingService.constraints.max_quantity_rule === 'room_extra_capacity'">Match Room Capacity</option>
                                     </select>
                                 </div>
