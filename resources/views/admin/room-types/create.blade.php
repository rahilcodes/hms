            ...
            <form action="{{ route('admin.room-types.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="child_price" value="0" min="0" step="0.01"
                            class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="extra_mattress_price" value="0" min="0" step="0.01"
                            class="w-full p-2.5 bg-gray-50 border border-gray-300 rounded focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>
                <div class="p-4 bg-blue-50/50 border border-blue-100 rounded-lg space-y-3">
                    <label class="flex items-center gap-2 text-sm font-semibold text-gray-700">
                        <input type="checkbox" name="day_use_enabled" value="1" class="w-4 h-4 rounded">
                        Enable Day-Use (hourly) booking
                    </label>
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-semibold text-gray-600 mb-1">4-hour slab (₹)</label>
                            <input type="number" name="day_use_price_4h" min="0" step="0.01"
                        ...
                        <div>
                            ...
                            <input type="number" name="day_use_price_8h" min="0" step="0.01"
                                class="w-full p-2.5 bg-white border border-gray-300 rounded">
                        </div>
                    </div>
                </div>
