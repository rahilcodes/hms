...
@section('header_title', 'Food Orders')
                        ...
                        @foreach($orders as $order)
                            <tr class="hover:bg-slate-50/50 transition">
                                ...
                                <td class="px-8 py-6">
                                    ...
                                    <a href="{{ route('admin.dining.orders.kot', $order) }}?print=1" target="_blank"
                                        class="mt-2 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-900 text-white text-[10px] font-black uppercase tracking-widest hover:bg-blue-600 transition">
                                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4H7v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z" />
                                        </svg>
                                        KOT {{ $order->kot_number ? '#' . $order->kot_number : '' }}
                                    </a>
                                </td>
                            </tr>
                        @endforeach
